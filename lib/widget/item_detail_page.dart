...
class _ItemDetailState extends State<ItemDetailpage> {
  ...
  Widget initWidget(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0.0,
        backgroundColor: Color(0xff80A1FE),
        centerTitle: true,
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color: Color(0xff80A1FE),
                  borderRadius: BorderRadius.only(bottomLeft: Radius.circular(30), bottomRight: Radius.circular(30))
              ),
              child: Container(
                margin: EdgeInsets.only(right: 250, bottom: 170),
                child: Row(
                  children: [
                    Container(
            ...
            Container(
              ...
              child: GridView.count(
                ...
                children: [
                  doctorTimingsData("08:00 AM", true),
            ...
            Container(
              ...
              child: GridView.count(
                ...
                children: [
                  doctorTimingsData("06:00 PM", true),
                  doctorTimingsData("07:00 PM", false),
                  doctorTimingsData("08:00 PM", false),
                  doctorTimingsData("09:00 PM", false),
                  doctorTimingsData("10:00 PM", false),
                  doctorTimingsData("11:00 PM", false),
                ],
              ),
            ),
            Container(
